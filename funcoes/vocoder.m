function saida = vocoder(entrada,freq_amost,tipo_vocoder,bandwidths_in,upper_freq,lower_freq,vet_tempo)
    switch(tipo_vocoder)
       ...
       Bandas = CIFilterBank(freq_amost, size(entrada,1), (upper_freq(1) + lower_freq(1))/2, Ruido, flipud(bandwidths_in));
       ...
       %Bandas = flipud(Bandas);
        ...
        Bandas = CIFilterBank(freq_amost, size(entrada,1), (upper_freq(1) + lower_freq(1))/2, SOMA, flipud(bandwidths_in));
