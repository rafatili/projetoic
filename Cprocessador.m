classdef Cprocessador < handle
    ...
    properties (Access = public)
        ...
        tipo_env = 'Hilbert' % Tipo de extração da envoltoria
        fcorte_fpb = 400; % Frequência de corte do FPB apos retificacao
        ...
        paciente = 'media' % Utilização das informacoes do 'paciente padrao' da clase
